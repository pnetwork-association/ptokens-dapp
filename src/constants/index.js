...
export const WALLET_SEPOLIA_CONNECTED = 'WALLET_SEPOLIA_CONNECTED'
export const WALLET_SEPOLIA_DISCONNECTED = 'WALLET_SEPOLIA_DISCONNECTED'
export const WALLET_SEPOLIA_NETWORK_CHANGED = 'WALLET_SEPOLIA_NETWORK_CHANGED'
export const WALLET_SEPOLIA_ACCOUNT_CHANGED = 'WALLET_SEPOLIA_ACCOUNT_CHANGED'
export const WALLET_GOERLI_CONNECTED = 'WALLET_GOERLI_CONNECTED'
export const WALLET_GOERLI_DISCONNECTED = 'WALLET_GOERLI_DISCONNECTED'
export const WALLET_GOERLI_NETWORK_CHANGED = 'WALLET_GOERLI_NETWORK_CHANGED'
export const WALLET_GOERLI_ACCOUNT_CHANGED = 'WALLET_GOERLI_ACCOUNT_CHANGED'
...
export const WBTC_ON_ETH_MAINNET = 'WBTC_ON_ETH_MAINNET'
export const PBTC_ON_EOS_MAINNET = 'PBTC_ON_EOS_MAINNET'
export const PBTC_ON_TELOS_MAINNET = 'PBTC_ON_TELOS_MAINNET'
export const PBTC_ON_LIBRE_MAINNET = 'PBTC_ON_LIBRE_MAINNET'
...
export const PKEYS_ON_BSC_MAINNET = 'PKEYS_ON_BSC_MAINNET'
export const OATH_ON_ETH_MAINNET = 'OATH_ON_ETH_MAINNET'
export const PBTC_ON_ALGORAND_MAINNET = 'PBTC_ON_ALGORAND_MAINNET'
export const PUSDC_ON_ALGORAND_MAINNET = 'PUSDC_ON_ALGORAND_MAINNET'
...
// migrations assets
export const PBTC_ON_ETH_MAINNET_V1_MIGRATION = 'PBTC_ON_ETH_MAINNET_V1_MIGRATION'
export const PBTC_ON_ETH_MAINNET_V2_MIGRATION = 'PBTC_ON_ETH_MAINNET_V2_MIGRATION'
export const PNT_ON_ETH_MAINNET = 'PNT_ON_ETH_MAINNET'
export const ETHPNT_ON_ETH_MAINNET = 'ETHPNT_ON_ETH_MAINNET'
