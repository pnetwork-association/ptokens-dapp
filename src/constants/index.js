...
export const PLTC_ON_EOS_MAINNET = 3
export const PETH_ON_EOS_MAINNET = 4
export const PBTC_ON_ETH_TESTNET = 5
export const PBTC_ON_EOS_TESTNET = 6
export const PLTC_ON_ETH_TESTNET = 7
