...
describe('isValidSwap', () => {
  ...
  test.each([
    ...
    ['PBTC_ON_ALGORAND_MAINNET', ['BTC', 'PBTC_ON_BSC_MAINNET', 'PBTC_ON_ETH_MAINNET', 'PBTC_ON_LIBRE_MAINNET']],
    ['PBTC_ON_LIBRE_MAINNET', ['BTC', 'PBTC_ON_BSC_MAINNET', 'PBTC_ON_ETH_MAINNET', 'PBTC_ON_ALGORAND_MAINNET']],
    ['WBTC_ON_ETH_MAINNET', ['BTC', 'PBTC_ON_BSC_MAINNET', 'PBTC_ON_LIBRE_MAINNET', 'PBTC_ON_ALGORAND_MAINNET']],
    [
      'USDT',
