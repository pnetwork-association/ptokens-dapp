...
export const PNT_ON_EOS_MAINNET = 5
export const PMKR_ON_EOS_MAINNET = 6
export const PLINK_ON_EOS_MAINNET = 7
export const PYFI_ON_EOS_MAINNET = 8
export const PBTC_ON_ETH_TESTNET = 9
export const PBTC_ON_EOS_TESTNET = 10
export const PLTC_ON_ETH_TESTNET = 11
