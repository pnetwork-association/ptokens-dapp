...
export const SET_SELECTED_PAGE_FROM_PATHNAME = 'SET_SELECTED_PAGE_FROM_PATHNAME'
...
//enclave
export const ENCLAVE_PING_PONG = 'ENCLAVE_PING_PONG'
export const ENCLAVE_LAST_ISSUER_PROCESSED_BLOCK_LOADED = 'ENCLAVE_LAST_ISSUER_PROCESSED_BLOCK_LOADED'
export const ENCLAVE_LAST_REDEEMER_PROCESSED_BLOCK_LOADED = 'ENCLAVE_LAST_REDEEMER_PROCESSED_BLOCK_LOADED'
export const ENCLAVE_BLOCK_SUBMITTED = 'ENCLAVE_BLOCK_SUBMITTED'
export const ENCLAVE_RESET_BLOCK_SUBMIT_SUCCESS = 'ENCLAVE_RESET_BLOCK_SUBMIT_SUCCESS'
export const ENCLAVE_REPORT_ISSUE_LOADED = 'ENCLAVE_REPORT_ISSUE_LOADED'
export const ENCLAVE_REPORT_REDEEM_LOADED = 'ENCLAVE_REPORT_REDEEM_LOADED'
export const ENCLAVE_RESET_DATA = 'ENCLAVE_RESET_DATA'
export const ENCLAVE_SET_ISSUER_BLOCK_HEIGHT_STATUS = 'ENCLAVE_SET_ISSUER_BLOCK_HEIGHT_STATUS'
export const ENCLAVE_SET_REDEEMER_BLOCK_HEIGHT_STATUS = 'ENCLAVE_SET_REDEEMER_BLOCK_HEIGHT_STATUS'
